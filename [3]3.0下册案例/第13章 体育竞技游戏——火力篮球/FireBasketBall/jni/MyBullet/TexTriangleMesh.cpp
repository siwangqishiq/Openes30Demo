...
float* TexTriangleMesh::vertices_yuanhuan = NULL;
int TexTriangleMesh::numsVer_yuanhuan = 0;
int* TexTriangleMesh::indices_yuanhuan = NULL;
int TexTriangleMesh::numsInd_yuanhuan = 0;
float* TexTriangleMesh::texs_yuanhuan = NULL;
int TexTriangleMesh::numsTex_yuanhuan = 0;
float* TexTriangleMesh::normal_yuanhuan = NULL ;
int TexTriangleMesh::numNormal_yuanhuan = 0 ;
...
//	int vertStride = sizeof(btVector3);//一个顶点所占的字节数  4*4 提示:xyzw四个坐标值 * 每一个坐标所在字节数
	...
	ctm = new AnyShapeByVectices(
			...
			false,
			1.0f,
			ShaderManager::getLigntAndTexturehaderProgram()
			);//三角形问题
